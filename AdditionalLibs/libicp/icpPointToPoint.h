...
private:
  ...
  double fitStep (double *T,const int32_t T_num,ICPMatrix &R,ICPMatrix &t,const std::vector<int32_t> &active);
  std::vector<int32_t> getInliers (double *T,const int32_t T_num,const ICPMatrix &R,const ICPMatrix &t,const double indist);
};
