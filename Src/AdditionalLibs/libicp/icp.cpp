...
void Icp::fit (double *T,const int32_t T_num,ICPMatrix &R,ICPMatrix &t,const double indist) {
...
void Icp::fitIterate(double *T,const int32_t T_num,ICPMatrix &R,ICPMatrix &t,const std::vector<int32_t> &active) {
