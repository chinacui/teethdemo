...
public:
  ...
  void fit(double *T,const int32_t T_num,ICPMatrix &R,ICPMatrix &t,const double indist);
  
private:
  
  // iterative fitting
  void fitIterate(double *T,const int32_t T_num,ICPMatrix &R,ICPMatrix &t,const std::vector<int32_t> &active);
  
  // inherited classes need to overwrite these functions
  virtual double               fitStep(double *T,const int32_t T_num,ICPMatrix &R,ICPMatrix &t,const std::vector<int32_t> &active) = 0;
  virtual std::vector<int32_t> getInliers(double *T,const int32_t T_num,const ICPMatrix &R,const ICPMatrix &t,const double indist) = 0;
