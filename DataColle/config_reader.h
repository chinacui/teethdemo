...
*
*/
class DATACOLLE_CLASS ConfigReader {
	// Data  
protected:
...
public:
	...
	ConfigReader(std::string filename, std::string delimiter = "=", std::string comment = "#");
	ConfigReader();
...
/* static */
template<class T>
std::string ConfigReader::T_as_string(const T& t)
{
...
/* static */
template<class T>
T ConfigReader::string_as_T(const std::string& s)
{
...
/* static */
template<>
inline std::string ConfigReader::string_as_T<std::string>(const std::string& s)
{
...
/* static */
template<>
inline bool ConfigReader::string_as_T<bool>(const std::string& s)
{
...
template<class T>
T ConfigReader::Read(const std::string& key) const
{
...
template<class T>
T ConfigReader::Read(const std::string& key, const T& value) const
{
...
template<class T>
bool ConfigReader::ReadInto(T& var, const std::string& key) const
{
...
template<class T>
bool ConfigReader::ReadInto(T& var, const std::string& key, const T& value) const
{
	// Get the value corresponding to key and store in var  
	// Return true if key is found  
...
template<class T>
void ConfigReader::Add(const std::string& in_key, const T& value)
{
